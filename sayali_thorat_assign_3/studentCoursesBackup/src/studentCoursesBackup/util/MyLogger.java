...
public class MyLogger {
  ...
  DEBUG_VALUE=3 [Print to stdout everytime the course is deleted.(Specified in TreeBuilder.java file)]
  DEBUG_VALUE=2 [FIXME: Print to stdout everytime  you write results to file.(Specified in Results.java file)]
  DEBUG_VALUE=1 [FIXME: Print to stdout everytime you are reading from file.(Specified in Driver.java file)]
  DEBUG_VALUE=0 [No output should be printed from the applicatio to stdout. It is ok to write to the output file though" ]
*/

public static enum DebugLevel {RELEASE, FILEREAD, IN_RESULTS, DELETE_COURSE, CONSTRUCTOR , NONE
                               };
...
public static void setDebugValue (int levelIn) {
	switch (levelIn) {
	  ...
	  case 3: debugLevel = DebugLevel.DELETE_COURSE; 
			break;
			
	  case 2: debugLevel = DebugLevel.IN_RESULTS; 
			break;
			
	  case 1: debugLevel = DebugLevel.FILEREAD; 
			break;
